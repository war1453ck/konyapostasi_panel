    ...
    <div className="p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3 sm:space-y-0">
        <div className="flex-1">
          <h1 className="text-xl sm:text-2xl font-bold text-foreground">Reklam Yönetimi</h1>
          <p className="text-sm sm:text-base text-muted-foreground">Reklamları yönetin ve performansları takip edin</p>
        </div>
        <Button onClick={handleCreateAd} className="w-full sm:w-auto min-h-[44px]">
          <LucideIcons.Plus className="w-4 h-4 mr-2" />
          <span className="hidden sm:inline">Yeni Reklam</span>
          <span className="sm:hidden">Reklam Ekle</span>
        </Button>
      </div>
